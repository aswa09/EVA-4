...
from lrfinder import StateCacher, ExponentialLR, LinearLR
...
def get_best_lr(args,model,criterion,optimizer,device,train_loader,test_loader):
      lr_finder = LRRangeFinder(model,optimizer, criterion, device)
      lr_finder.range_test(train_loader, val_loader=test_loader, start_lr=args['lrate'], end_lr=args['end_lr'],epochs=args['lr_epochs'], step_mode=args['step_mode'])
