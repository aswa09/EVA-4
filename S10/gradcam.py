...
class VisualizeCam(object):
    ...
    def plot_heatmaps(self, img_data, len_data, img_name):
        fig, axs = plt.subplots(nrows=len_data, ncols=5, figsize=(10, 2 * len_data),
    ...
    def __call__(self, images, images_gradcam, target_layers, target_inds=None, metric=""):
        ...
        fname = "gradcam"
        self.plot_heatmaps(heatmaps_data, len(images), fname)
