...
from .infdataloader import InfiniteDataLoader
...
class Learner:
    ...
    def train_batch(self, data, target):
        ...
        if self.l1_factor > 0:
            ...
            loss += self.l1_factor * regularizer_loss
    ...
    def train_epoch(self):
        ...
        for batch_idx, (data, target) in enumerate(pbar):
            ...
            pbar.set_description(
                desc=f'Loss={loss:0.4f} Batch_id={batch_idx} Accuracy={100 * self.train_correct / self.train_processed:0.2f}')

        # Update training history
        accuracy = 100 * self.train_correct / self.train_processed
        self.update_training_history(loss, accuracy)

        pbar.set_description(desc=f'Loss={loss:0.4f} Batch_id={1} Accuracy={accuracy:0.2f}')
    ...
    def train_iterations(self):
        ...
        for iteration in range(self.epochs):
            ...
            accuracy = 100 * self.train_correct / self.train_processed
            pbar.set_description(
                desc=f'Loss={loss:0.4f} Iteration={iteration} Accuracy={100 * self.train_correct / self.train_processed:0.2f}')
        ...
        pbar.set_description(desc=f'Loss={loss:0.4f} Iteration={1} Accuracy={accuracy:0.2f}')
